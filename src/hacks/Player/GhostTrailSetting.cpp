...
namespace superhack::Player {
    // Hook để lưu trạng thái ghost hiện tại
        ...
        void init() override {
            ...
            ->callback([](bool v) {
                ...
                if (pl->m_gameState.m_isDualMode) 
                    p2->toggleGhostEffect(p2->m_fields->m_curGhostType);
            });
        }
