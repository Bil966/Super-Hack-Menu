...
namespace superhack::Player {
    // Hook để lưu trạng thái visibility hiện tại
    ...
    class $hack(HidePlayer) {
        void init() override {
            ...
            ->callback([](bool v) {
                ...
                if (gjbgl->m_gameState.m_isDualMode) 
                    p2->toggleVisibility(p2->m_fields->m_isPlayerInvis);
            });
        }
